...
public class CommentRestController {
	...
	@PostMapping("/create")
	public Map<String, Object> create(@RequestParam("lolPostId") int lolPostId, @RequestParam("content") String content,
			HttpSession session) {
		...
		commentBO.addComment(lolPostId, userId, content);
