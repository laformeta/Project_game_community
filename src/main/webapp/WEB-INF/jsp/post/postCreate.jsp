...
<div class="d-flex justify-content-center">
	<div class="w-50">
		...
		<textarea id="content" class="form-control" placeholder="내용을 입력하세요"
			...
			<img id="imagePreview" src="#" alt="Image Preview" width="200px"
			height="200px">
		...
		<div class="d-flex justify-content-between my-3">
			...
			<button type="button" id="clearBtn" class="btn btn-secondary">파일 지우기
				</button>
			<div class="mx-1">
				...
				$("#saveBtn").on(
						...
						function() {
							...
							formData.append("nickname",
									"${sessionScope.userNickname}"); // 세션에서 사용자 닉네임 가져오기
